...
<div class="relative h-full overflow-hidden group">
  ...
  <div class="absolute inset-0 flex flex-col justify-end p-4 bg-black bg-opacity-0 group-hover:bg-opacity-75 transition-all duration-300">
    <div class="transform group-hover:translate-y-0 transition-all duration-300">
      <h3 class="text-white text-xs group-hover:text-xl font-bold absolute bottom-2 right-2 group-hover:static group-hover:mb-2 transition-all duration-300">{project.name}</h3>
